...
var file_proxyservice_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x11, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x53,
...
var file_proxyservice_proto_goTypes = []interface{}{
	...
	(*GetStateRequest)(nil),       // 3: proxyservice.GetStateRequest
	(*GetStateResponse)(nil),      // 4: proxyservice.GetStateResponse
	(*ServerState)(nil),           // 5: proxyservice.ServerState
	(*AppState)(nil),              // 6: proxyservice.AppState
	(*Sample)(nil),                // 7: proxyservice.Sample
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_proxyservice_proto_depIdxs = []int32{
	8, // 0: proxyservice.Settings.temporaryRxSpeedExpiry:type_name -> google.protobuf.Timestamp
	...
	3, // 3: proxyservice.Request.getState:type_name -> proxyservice.GetStateRequest
	6, // 4: proxyservice.ServerState.apps:type_name -> proxyservice.AppState
	8, // 5: proxyservice.Sample.startTime:type_name -> google.protobuf.Timestamp
