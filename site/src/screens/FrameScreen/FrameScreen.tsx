...
export const FrameScreen = (): JSX.Element => {
  return (
    <div className="flex flex-col items-center justify-center relative">
      <div className="flex flex-col items-center gap-[282px] pt-[122px] pb-[269px] px-0 relative self-stretch w-full flex-[0_0_auto] [background:linear-gradient(180deg,_rgb(255,_255,_255)_0%,_rgb(255,_255,_255)_0.01%,_rgb(255,_222,_187)_100%)]">
        <div className="flex max-w-[1200px] items-start justify-between relative self-stretch w-full flex-[0_0_auto]">
        ...
        <div className="flex flex-col max-w-[1200px] items-start gap-[161px] relative self-stretch w-full flex-[0_0_auto] rounded-[5px] overflow-hidden">
      ...
      <div className="flex flex-col h-[1024px] items-center justify-center gap-[10px] relative self-stretch w-full bg-black">
        <div className="flex flex-col max-w-[1200px] items-start justify-center gap-[103px] relative self-stretch w-full flex-[0_0_auto]">
